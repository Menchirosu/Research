...
export function printUsage() {
  ...
  node src/cli.js overnight --topic="..." [--watchlist-file=config/threads-watchlist.json] [--seeded-posts-file=config/seeded-posts.json] [--discovered-posts-file=var/queues/threads-discovered-posts.json] [--stretch-budget] [--allow-older-target]
  ...
  node src/cli.js targets discover [--watchlist-file=config/threads-watchlist.json] [--discovered-posts-file=var/queues/threads-discovered-posts.json] [--usernames=claudeai,openai,github] [--limit=10]
